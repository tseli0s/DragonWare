/**********************************************************************
 * FILE: multiboot.h
 * PURPOSE: Multiboot protocol exports for internal kernel use
...
typedef struct [[gnu::packed]] _Multiboot {
        ...
        /* There's some a.out/ELF stuff here that I omitted from this header. It was
...
typedef struct [[gnu::packed]] _MultibootModule {
        u32  start, end;
        u32  cmdline;    /* We don't expect a command line from modules but this is needed for ABI
                            compatibility */
