 ...
 */
[[gnu::nonnull, nodiscard("Return value of copying from userspace should often be inspected for "
                          "security reasons.")]]
 ...
 */
[[gnu::nonnull, nodiscard("Return value of copying to userspace should possibly be inspected, for "
                          "security reasons.")]]
