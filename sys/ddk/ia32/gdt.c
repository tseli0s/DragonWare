...
#define X86_MEMORY_LIMIT  (0xFFFFFFFF)
...
void GDTInit(void) {
        ...
        GDTSetGate(1, 0, X86_MEMORY_LIMIT, 0x9A, 0xCF); /* Kernel code */
        GDTSetGate(2, 0, X86_MEMORY_LIMIT, 0x92, 0xCF); /* Kernel data */
        GDTSetGate(3, 0, X86_MEMORY_LIMIT, 0xFA, 0xCF); /* User code */
        GDTSetGate(4, 0, X86_MEMORY_LIMIT, 0xF2, 0xCF); /* User data */
