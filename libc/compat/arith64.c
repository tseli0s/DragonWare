...
arith64_u64 __divmoddi4(arith64_u64 a, arith64_u64 b, arith64_u64 *c) {
        ...
        char bits =
                __clzdi2(b) - __clzdi2(a) + 1;  // number of bits to iterate (a and b are non-zero)
...
/* This function was taken from libgcc, simply adapted to work well with this file. It was not part
 * of it originally. It's required in some, but not all, build platforms to be present. */
