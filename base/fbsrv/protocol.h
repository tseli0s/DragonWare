...
/**
 * Since we already have vgacons, this "protocol" is supposed to be binary and source compatible
 * with the vgacons protocol. On top of that, we will also export framebuffer-specific operations
 * (like drawing basic 2D shapes, getting values of pixels, maybe share the whole framebuffer in
 * some cases).
 */
...
/* Framebuffer driver protocol version 0 */
#define FBSRV_PROTOCOL_V0               ((u16)0xE000)
